...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s([])},28248,e=>{"use strict";var o=e.i(33967);let i="clipPlaneFragmentDeclaration",t=`#ifdef CLIPPLANE
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["clipPlaneFragmentDeclaration",0,{name:i,shader:t}])},11364,e=>{"use strict";var o=e.i(33967);let i="clipPlaneFragment",t=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["clipPlaneFragment",0,{name:i,shader:t}])},24137,e=>{"use strict";var o=e.i(33967);let i="logDepthDeclaration",t=`#ifdef LOGARITHMICDEPTH
