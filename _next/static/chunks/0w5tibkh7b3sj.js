(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,61404,e=>{"use strict";var i=e.i(33967);let a="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([])},660,76073,e=>{"use strict";var i=e.i(33967);let a="importanceSampling",n=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([],660);let r="hdrFilteringFunctions",t=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.s([],76073)},79213,56261,e=>{"use strict";var i=e.i(33967);let a="samplerFragmentDeclaration",n=`#ifdef _DEFINENAME_
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([],56261);let r="bumpFragmentFunctions",t=`#if defined(BUMP)
...
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.s(["bumpFragmentFunctions",0,{name:r,shader:t}],79213)},99354,e=>{"use strict";var i=e.i(33967);let a="bumpFragment",n=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s(["bumpFragment",0,{name:a,shader:n}])},50862,e=>{"use strict";var i=e.i(33967);let a="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s(["bumpFragmentMainFunctions",0,{name:a,shader:n}])},488,17046,e=>{"use strict";var i=e.i(33967);let a="prePassDeclaration",n=`#ifdef PREPASS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([],488);let r="oitDeclaration",t=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.s([],17046)},20302,e=>{"use strict";var i=e.i(33967);let a="decalFragmentDeclaration",n=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([])},90699,45e3,88783,e=>{"use strict";var i=e.i(33967);let a="decalFragment",n=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.s([],90699);let r="depthPrePass",t=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.s([],45e3);let o="oitFragment",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=f),e.s([],88783)},5168,85024,e=>{"use strict";var i=e.i(33967);e.i(488),e.i(17046),e.i(20302);let a="pbrFragmentDeclaration",n=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=n),e.i(44897),e.i(2522);let r="pbrFragmentExtraDeclaration",t=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.i(54268),e.i(65581),e.i(56261);let o="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=f);let l="pbrFragmentSamplersDeclaration",c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.ShaderStore.IncludesShadersStore[l]||(i.ShaderStore.IncludesShadersStore[l]=c),e.i(31713),e.i(28248),e.i(24137),e.i(1414),e.i(13851);let d="subSurfaceScatteringFunctions",s=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;i.ShaderStore.IncludesShadersStore[d]||(i.ShaderStore.IncludesShadersStore[d]=s),e.s([],85024),e.i(660);let E="pbrHelperFunctions",R=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=R),e.i(41092),e.i(78267),e.i(92050),e.i(57940);let S="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
...
#endif
`;i.ShaderStore.IncludesShadersStore[S]||(i.ShaderStore.IncludesShadersStore[S]=u);let C="pbrDirectLightingFalloffFunctions",m=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;i.ShaderStore.IncludesShadersStore[C]||(i.ShaderStore.IncludesShadersStore[C]=m),e.i(61404),e.i(76073);let v="pbrDirectLightingFunctions",A=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;i.ShaderStore.IncludesShadersStore[v]||(i.ShaderStore.IncludesShadersStore[v]=A);let I="pbrIBLFunctions",N=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.ShaderStore.IncludesShadersStore[I]||(i.ShaderStore.IncludesShadersStore[I]=N),e.i(50862),e.i(79213),e.i(12369),e.i(90699);let p="pbrBlockAlbedoOpacity",T=`struct albedoOpacityOutParams
...
`;i.ShaderStore.IncludesShadersStore[p]||(i.ShaderStore.IncludesShadersStore[p]=T);let O="pbrBlockReflectivity",L=`struct reflectivityOutParams
...
`;i.ShaderStore.IncludesShadersStore[O]||(i.ShaderStore.IncludesShadersStore[O]=L);let g="pbrBlockAmbientOcclusion",h=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;i.ShaderStore.IncludesShadersStore[g]||(i.ShaderStore.IncludesShadersStore[g]=h);let D="pbrBlockAlphaFresnel",_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[D]||(i.ShaderStore.IncludesShadersStore[D]=_);let M="pbrBlockAnisotropic",F=`#ifdef ANISOTROPIC
...
#endif
`;i.ShaderStore.IncludesShadersStore[M]||(i.ShaderStore.IncludesShadersStore[M]=F);let P="pbrBlockReflection",b=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=b);let U="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;i.ShaderStore.IncludesShadersStore[U]||(i.ShaderStore.IncludesShadersStore[U]=B);let G="pbrBlockClearcoat",y=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[G]||(i.ShaderStore.IncludesShadersStore[G]=y);let V="pbrBlockIridescence",H=`struct iridescenceOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=W),e.i(11364);let X="pbrBlockNormalGeometric",k=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;i.ShaderStore.IncludesShadersStore[X]||(i.ShaderStore.IncludesShadersStore[X]=k),e.i(99354);let Y="pbrBlockNormalFinal",w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;i.ShaderStore.IncludesShadersStore[Y]||(i.ShaderStore.IncludesShadersStore[Y]=w),e.i(45e3);let z="pbrBlockLightmapInit",q=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[z]||(i.ShaderStore.IncludesShadersStore[z]=q);let K="pbrBlockGeometryInfo",Z=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[K]||(i.ShaderStore.IncludesShadersStore[K]=Z);let J="pbrBlockReflectance0",j=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;i.ShaderStore.IncludesShadersStore[J]||(i.ShaderStore.IncludesShadersStore[J]=j);let Q="pbrBlockReflectance",$=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[Q]||(i.ShaderStore.IncludesShadersStore[Q]=$);let ee="pbrBlockDirectLighting",ei=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;i.ShaderStore.IncludesShadersStore[ee]||(i.ShaderStore.IncludesShadersStore[ee]=ei),e.i(71871);let ea="pbrBlockFinalLitComponents",en=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[ea]||(i.ShaderStore.IncludesShadersStore[ea]=en);let er="pbrBlockFinalUnlitComponents",et=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;i.ShaderStore.IncludesShadersStore[er]||(i.ShaderStore.IncludesShadersStore[er]=et);let eo="pbrBlockFinalColorComposition",ef=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.ShaderStore.IncludesShadersStore[eo]||(i.ShaderStore.IncludesShadersStore[eo]=ef),e.i(93563),e.i(93741);let el="pbrBlockImageProcessing",ec=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.ShaderStore.IncludesShadersStore[el]||(i.ShaderStore.IncludesShadersStore[el]=ec);let ed="pbrBlockPrePass",es=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[ed]||(i.ShaderStore.IncludesShadersStore[ed]=es),e.i(88783);let eE="pbrDebug",eR=`#if DEBUGMODE>0
...
#endif
`;i.ShaderStore.IncludesShadersStore[eE]||(i.ShaderStore.IncludesShadersStore[eE]=eR);let eS="pbrPixelShader",eu=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;i.ShaderStore.ShadersStore[eS]||(i.ShaderStore.ShadersStore[eS]=eu),e.s(["pbrPixelShader",0,{name:eS,shader:eu}],5168)}]);