...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],33554)},81303,e=>{"use strict";var r=e.i(33967);let a="bumpFragment",i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s(["bumpFragmentWGSL",0,{name:a,shader:i}])},24732,e=>{"use strict";var r=e.i(33967);let a="bumpFragmentMainFunctions",i=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s(["bumpFragmentMainFunctionsWGSL",0,{name:a,shader:i}])},76066,16288,e=>{"use strict";var r=e.i(33967);let a="samplerFragmentDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],16288);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s(["bumpFragmentFunctionsWGSL",0,{name:n,shader:f}],76066)},63451,e=>{"use strict";var r=e.i(33967);let a="decalFragment",i=`#ifdef DECAL
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([])},72458,44569,e=>{"use strict";var r=e.i(33967);let a="prePassDeclaration",i=`#ifdef PREPASS
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],72458);let n="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],44569)},29589,29981,e=>{"use strict";var r=e.i(33967);let a="depthPrePass",i=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],29589);let n="oitFragment",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],29981)},74532,45837,e=>{"use strict";var r=e.i(33967);e.i(72458),e.i(44569),e.i(10050),e.i(73043);let a="pbrFragmentExtraDeclaration",i=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.i(4796),e.i(16288);let n="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f);let t="pbrFragmentSamplersDeclaration",o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.i(73547),e.i(23393),e.i(27104),e.i(13483),e.i(66911);let c="subSurfaceScatteringFunctions",l=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;r.ShaderStore.IncludesShadersStoreWGSL[c]||(r.ShaderStore.IncludesShadersStoreWGSL[c]=l),e.s([],45837),e.i(35620);let d="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=s),e.i(53444),e.i(94905),e.i(33554),e.i(25865);let E="pbrDirectLightingSetupFunctions",m=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[E]||(r.ShaderStore.IncludesShadersStoreWGSL[E]=m);let S="pbrDirectLightingFalloffFunctions",v=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;r.ShaderStore.IncludesShadersStoreWGSL[S]||(r.ShaderStore.IncludesShadersStoreWGSL[S]=v),e.i(73728),e.i(55755);let u="pbrDirectLightingFunctions",R=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[u]||(r.ShaderStore.IncludesShadersStoreWGSL[u]=R);let p="pbrIBLFunctions",C=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[p]||(r.ShaderStore.IncludesShadersStoreWGSL[p]=C),e.i(24732),e.i(76066),e.i(94234),e.i(63451);let A="pbrBlockAlbedoOpacity",I=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;r.ShaderStore.IncludesShadersStoreWGSL[A]||(r.ShaderStore.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockReflectivity",O=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[N]||(r.ShaderStore.IncludesShadersStoreWGSL[N]=O);let T="pbrBlockAmbientOcclusion",L=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[T]||(r.ShaderStore.IncludesShadersStoreWGSL[T]=L);let h="pbrBlockAlphaFresnel",g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[h]||(r.ShaderStore.IncludesShadersStoreWGSL[h]=g);let M="pbrBlockAnisotropic",D=`#ifdef ANISOTROPIC
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[M]||(r.ShaderStore.IncludesShadersStoreWGSL[M]=D);let _="pbrBlockReflection",F=`#ifdef REFLECTION
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[_]||(r.ShaderStore.IncludesShadersStoreWGSL[_]=F);let P="pbrBlockSheen",U=`#ifdef SHEEN
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[P]||(r.ShaderStore.IncludesShadersStoreWGSL[P]=U);let b="pbrBlockClearcoat",B=`struct clearcoatOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[b]||(r.ShaderStore.IncludesShadersStoreWGSL[b]=B);let G="pbrBlockIridescence",y=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[G]||(r.ShaderStore.IncludesShadersStoreWGSL[G]=y);let x="pbrBlockSubSurface",V=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[x]||(r.ShaderStore.IncludesShadersStoreWGSL[x]=V),e.i(94932);let H="pbrBlockNormalGeometric",W=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[H]||(r.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(81303);let X="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[X]||(r.ShaderStore.IncludesShadersStoreWGSL[X]=Y),e.i(29589);let w="pbrBlockLightmapInit",k=`#ifdef LIGHTMAP
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[w]||(r.ShaderStore.IncludesShadersStoreWGSL[w]=k);let z="pbrBlockGeometryInfo",K=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[q]||(r.ShaderStore.IncludesShadersStoreWGSL[q]=Z);let J="pbrBlockReflectance",j=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[J]||(r.ShaderStore.IncludesShadersStoreWGSL[J]=j);let Q="pbrBlockDirectLighting",$=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[Q]||(r.ShaderStore.IncludesShadersStoreWGSL[Q]=$),e.i(48835);let ee="pbrBlockFinalLitComponents",er=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[ee]||(r.ShaderStore.IncludesShadersStoreWGSL[ee]=er);let ea="pbrBlockFinalUnlitComponents",ei=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;r.ShaderStore.IncludesShadersStoreWGSL[ea]||(r.ShaderStore.IncludesShadersStoreWGSL[ea]=ei);let en="pbrBlockFinalColorComposition",ef=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;r.ShaderStore.IncludesShadersStoreWGSL[en]||(r.ShaderStore.IncludesShadersStoreWGSL[en]=ef),e.i(51597),e.i(69219);let et="pbrBlockImageProcessing",eo=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[et]||(r.ShaderStore.IncludesShadersStoreWGSL[et]=eo);let ec="pbrBlockPrePass",el=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[ec]||(r.ShaderStore.IncludesShadersStoreWGSL[ec]=el),e.i(29981);let ed="pbrDebug",es=`#if DEBUGMODE>0
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[ed]||(r.ShaderStore.IncludesShadersStoreWGSL[ed]=es);let eE="pbrPixelShader",em=`#define CUSTOM_FRAGMENT_BEGIN
...
`;r.ShaderStore.ShadersStoreWGSL[eE]||(r.ShaderStore.ShadersStoreWGSL[eE]=em),e.s(["pbrPixelShaderWGSL",0,{name:eE,shader:em}],74532)}]);