(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,74532,45837,e=>{"use strict";var r=e.i(33967);e.i(72458),e.i(44569),e.i(10050),e.i(73043);let i="pbrFragmentExtraDeclaration",a=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.i(4796),e.i(16288);let n="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=s),e.i(53444),e.i(94905),e.i(33554),e.i(25865);let E="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[E]||(r.ShaderStore.IncludesShadersStoreWGSL[E]=S);let m="pbrDirectLightingFalloffFunctions",R=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;r.ShaderStore.IncludesShadersStoreWGSL[m]||(r.ShaderStore.IncludesShadersStoreWGSL[m]=R),e.i(73728),e.i(55755);let u="pbrDirectLightingFunctions",v=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[u]||(r.ShaderStore.IncludesShadersStoreWGSL[u]=v);let C="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[C]||(r.ShaderStore.IncludesShadersStoreWGSL[C]=p),e.i(24732),e.i(76066),e.i(94234),e.i(63451);let A="pbrBlockAlbedoOpacity",I=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;r.ShaderStore.IncludesShadersStoreWGSL[A]||(r.ShaderStore.IncludesShadersStoreWGSL[A]=I);let O="pbrBlockReflectivity",N=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[O]||(r.ShaderStore.IncludesShadersStoreWGSL[O]=N);let T="pbrBlockAmbientOcclusion",L=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[T]||(r.ShaderStore.IncludesShadersStoreWGSL[T]=L);let M="pbrBlockAlphaFresnel",g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[M]||(r.ShaderStore.IncludesShadersStoreWGSL[M]=g);let h="pbrBlockAnisotropic",D=`#ifdef ANISOTROPIC
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[h]||(r.ShaderStore.IncludesShadersStoreWGSL[h]=D);let _="pbrBlockReflection",F=`#ifdef REFLECTION
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[P]||(r.ShaderStore.IncludesShadersStoreWGSL[P]=U);let G="pbrBlockClearcoat",b=`struct clearcoatOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[G]||(r.ShaderStore.IncludesShadersStoreWGSL[G]=b);let B="pbrBlockIridescence",y=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[B]||(r.ShaderStore.IncludesShadersStoreWGSL[B]=y);let V="pbrBlockSubSurface",x=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[V]||(r.ShaderStore.IncludesShadersStoreWGSL[V]=x),e.i(94932);let H="pbrBlockNormalGeometric",W=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[H]||(r.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(81303);let X="pbrBlockNormalFinal",k=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[X]||(r.ShaderStore.IncludesShadersStoreWGSL[X]=k),e.i(29589);let w="pbrBlockLightmapInit",Y=`#ifdef LIGHTMAP
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[w]||(r.ShaderStore.IncludesShadersStoreWGSL[w]=Y);let z="pbrBlockGeometryInfo",K=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[ee]||(r.ShaderStore.IncludesShadersStoreWGSL[ee]=er);let ei="pbrBlockFinalUnlitComponents",ea=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;r.ShaderStore.IncludesShadersStoreWGSL[ei]||(r.ShaderStore.IncludesShadersStoreWGSL[ei]=ea);let en="pbrBlockFinalColorComposition",ef=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[ed]||(r.ShaderStore.IncludesShadersStoreWGSL[ed]=es);let eE="pbrPixelShader",eS=`#define CUSTOM_FRAGMENT_BEGIN
...
`;r.ShaderStore.ShadersStoreWGSL[eE]||(r.ShaderStore.ShadersStoreWGSL[eE]=eS),e.s(["pbrPixelShaderWGSL",0,{name:eE,shader:eS}],74532)}]);