...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],33554)},24732,e=>{"use strict";var r=e.i(33967);let a="bumpFragmentMainFunctions",i=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s(["bumpFragmentFunctionsWGSL",0,{name:n,shader:f}],76066)},81303,e=>{"use strict";var r=e.i(33967);let a="bumpFragment",i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s(["bumpFragmentWGSL",0,{name:a,shader:i}])},63451,e=>{"use strict";var r=e.i(33967);let a="decalFragment",i=`#ifdef DECAL
