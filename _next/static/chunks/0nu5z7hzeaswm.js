(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,78267,e=>{"use strict";var o=e.i(33967);let i="shadowsFragmentFunctions",t=`#ifdef SHADOWS
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["shadowsFragmentFunctions",0,{name:i,shader:t}])},54268,e=>{"use strict";var o=e.i(33967);let i="lightFragmentDeclaration",t=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["lightFragmentDeclaration",0,{name:i,shader:t}])},65581,e=>{"use strict";var o=e.i(33967);let i="lightUboDeclaration",t=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s([])},12369,e=>{"use strict";var o=e.i(33967);let i="reflectionFunction",t=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["reflectionFunction",0,{name:i,shader:t}])},1414,e=>{"use strict";var o=e.i(33967);let i="fogFragmentDeclaration",t=`#ifdef FOG
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["fogFragmentDeclaration",0,{name:i,shader:t}])},93741,e=>{"use strict";var o=e.i(33967);let i="fogFragment",t=`#ifdef FOG
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s([])},11364,e=>{"use strict";var o=e.i(33967);let i="clipPlaneFragment",t=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["clipPlaneFragment",0,{name:i,shader:t}])},28248,e=>{"use strict";var o=e.i(33967);let i="clipPlaneFragmentDeclaration",t=`#ifdef CLIPPLANE
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["clipPlaneFragmentDeclaration",0,{name:i,shader:t}])},24137,e=>{"use strict";var o=e.i(33967);let i="logDepthDeclaration",t=`#ifdef LOGARITHMICDEPTH
uniform float logarithmicDepthConstant;varying float vFragmentDepth;
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s([])},93563,e=>{"use strict";var o=e.i(33967);let i="logDepthFragment",t=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s([])},31713,e=>{"use strict";var o=e.i(33967);let i="imageProcessingDeclaration",t=`#ifdef EXPOSURE
...
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["imageProcessingDeclaration",0,{name:i,shader:t}])},41092,e=>{"use strict";var o=e.i(33967);let i="imageProcessingFunctions",t=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["imageProcessingFunctions",0,{name:i,shader:t}])},71871,e=>{"use strict";var o=e.i(33967);let i="lightFragment",t=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[i]||(o.ShaderStore.IncludesShadersStore[i]=t),e.s(["lightFragment",0,{name:i,shader:t}])}]);