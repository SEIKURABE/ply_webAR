...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s(["bumpFragmentMainFunctionsWGSL",0,{name:a,shader:i}])},81303,e=>{"use strict";var r=e.i(33967);let a="bumpFragment",i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s(["bumpFragmentWGSL",0,{name:a,shader:i}])},76066,16288,e=>{"use strict";var r=e.i(33967);let a="samplerFragmentDeclaration",i=`#ifdef _DEFINENAME_
